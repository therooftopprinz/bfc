...
TEST(poll_reactor, rem_read_rdy_invokes_done_cb_on_reactor_thread)
{
    reactor_t reactor;
    bfc::socket client(create_tcp4());
    bfc::socket server;
...
TEST(poll_reactor, rem_read_rdy_suppresses_further_notifications)
{
    reactor_t reactor;
    bfc::socket client(create_tcp4());
    bfc::socket server;
...
TEST(poll_reactor, rem_write_rdy_invokes_done_cb_on_reactor_thread)
{
    reactor_t reactor;
    bfc::socket client(create_tcp4());
    bfc::socket server;
...
TEST(poll_reactor, is_reactor_thread)
{
    reactor_t reactor;
    bfc::socket client(create_tcp4());
    bfc::socket server;
...
TEST(poll_reactor, wake_up_cb_runs_on_reactor_thread)
{
    reactor_t reactor;
